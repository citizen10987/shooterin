...
export const Route = createFileRoute("/content/$id")({
  head: () => ({
    meta: [
      { title: "Script — Shooter" },
      { name: "description", content: "Script padhein, approve karein ya Hindi mein badlao bolein." },
      { property: "og:title", content: "Script — Shooter" },
      { property: "og:description", content: "Script padhein, approve karein ya Hindi mein badlao bolein." },
    ],
  }),
  loader: ({ params }) => {
  ...
  return (
    <AppShell>
      <div className="pb-[120px]">
        <Link to="/content" className="mb-4 inline-flex min-h-[44px] items-center gap-1 text-[16px] text-[#0F7FFF]">
