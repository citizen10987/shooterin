...
export const Route = createFileRoute("/ideas/$id")({
  head: () => ({
    meta: [
      { title: "Idea — Shooter" },
      { name: "description", content: "AI ka expansion, research aur agla kadam ek hi jagah." },
      { property: "og:title", content: "Idea — Shooter" },
      { property: "og:description", content: "AI ka expansion, research aur agla kadam ek hi jagah." },
    ],
  }),
  loader: ({ params }) => {
...
function IdeaDetail() {
  ...
  return (
    <AppShell>
      <Link to="/ideas" className="mb-4 inline-flex min-h-[44px] items-center gap-1 text-[16px] text-[#0F7FFF]">
